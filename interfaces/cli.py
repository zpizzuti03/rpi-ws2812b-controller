...
if args.progressive:
	...
	if args.interval is not None and args.duration is not None:
		print("You have entered both an interval and duration for progressive lights, however duration wins precedence over a specified interval. To see lights at a specified interval, please do not use the --duration flag")
	elif args.interval is None and args.duration is None:
		print("You have not entered an interval or a duration (use -h for more information), using a default interval of 1")
...
if args.blink:
	...
	if args.interval is None:
		print("You have not entered an interval, using default interval of 1 second, (see -h for more options)")
	if args.duration is None:
		print("You have not entered a duration, using default duration of 10 seconds, (see -h for more options)")

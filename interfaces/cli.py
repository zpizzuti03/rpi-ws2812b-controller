...
parser.add_argument("-f", "--fill", action='store_true', help="Fills the entire light strip with a specified color. Usage: '--fill'")
...
parser.add_argument("-s", "--blink", type=float, help="Blinks the entire light strip at a rate of time specified by a float value Usage: '--blink 1', '--blink 2.5'")
parser.add_argument("-i", "--interval", help="During development, being used to test any function requiring an interval via cli", type=int) 
